...
flowchart LR
    ...
    C["核心创新（壁垒型）<br/>知识图谱推理 / RAG 溯源 / 可解释性<br/>IN1-IN3"]
    X["体验创新（闭环型）<br/>多模态混合 / 一体化闭环 / 方剂推荐<br/>IN4-IN9"]
    S["安全创新（信任型）<br/>置信度提示 / 风险警示 / 本地降级<br/>IN10-IN12"]
    A["验收挂钩<br/>交付物 2/3 + 验收项 3/5"]
